  ...
  container_definitions = jsonencode([
    {
      ...
      image = "${var.ecr_repository_url_backend}:${var.environment}-latest"
      ...
      secrets = [
        ...
        { name = "JWT_REFRESH_SECRET", valueFrom = "${var.secrets_arn_prefix}/jwt-refresh-secret" }
      ]
  ...
  container_definitions = jsonencode([
    {
      ...
      image = "${var.ecr_repository_url_frontend}:${var.environment}-latest"
